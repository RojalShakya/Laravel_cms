        ...
        <div class="container">
            <div class="banner_content text-center">
                ...
                <div class="page_link">
                    ...
                    <a href="{{route('services')}}">Portfolio</a>
                    <a href="{{route('services')}}">Portfolio Details</a>
                </div>
    ...
    <div class="container">
        <div class="portfolio_details_inner">
            <div class="row">
                <div class="col-md-6">
                    <div class="left_img">
                        <img class="img-fluid" src="{{asset('frontend/img/gallery/portfolio_details.jpg')}}" alt="">
                    </div>
                </div>
                <div class="col-md-6">
